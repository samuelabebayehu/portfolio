  ...
  const projects = [
    {
      ...
      image: "/yesera.png", // Assuming a placeholder or the user will add the image later, using a generic name for now or sticking to placeholder if I can't generate.
      tags: ["Next.js", "Spring Boot", "Keycloak", "Docker", "PostgreSQL"],
      githubUrl: "https://github.com/samuelabebayehu", // Keeping generic as specific repo unknown
